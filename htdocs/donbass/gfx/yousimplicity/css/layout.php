...
#toppanel_in{height:30px; margin:0 auto; text-align:center; position:relative; z-index:6005}
...
#linkem{width:500px; height:30px; margin:0 auto; text-align:right; font-size:10px; float:right}
...
#rightblock{float:left; height:100% !Important; height:1%; overflow:hidden; text-align:left; background:url(../images/right_side.jpg) no-repeat 3px top}

.inside{padding:5px 0; overflow:hidden}

.insidem{padding:10px 0 5px 0}
...
#cp{text-align:left; padding:0; overflow:hidden; margin:15px 0 0 0}
...
.yjsquare_yj1 h3, 
.yjsquare_yj2 h3, 
.yjsquare_yj3 h3{text-transform:capitalize; font-weight:normal; overflow:hidden; font-size:18px; padding:0 0 0 5px; margin:5px}
.yjsquare h3 span, 
