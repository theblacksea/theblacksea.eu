...
function docReady(){
	...
	//rich text editor
	//$('.cleditor').cleditor();
	$('.ckeditorr').map(function(){
		var txaId  = $(this).attr('id');
		var height = $(this).height();
		//var txaName = $(this).attr('name');
		//var width  = $(this).width();

		// daca elementul are un toolbar declarat
		var toolbarName = $(this).data('cketoolbar');
		if (typeof  toolbarName == 'undefined' || toolbarName == '') {
			//toolbarName = (EDtag_width < 500 ? 'defaultSmall' : 'default' );
			toolbarName = 'default';
		}

		//alert("name = " + txaName + " toolbar = " + toolbarName);
		//$(this).ckeditor();
		CKEDITOR.replace( txaId ,{
			toolbar: toolbarName,
			height: height + "px"
		});
