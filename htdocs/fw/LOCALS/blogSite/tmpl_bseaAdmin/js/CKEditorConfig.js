...
// cofigure codemirror
	 ...
	 * unde are nevoie
	 * */
	config.contentsCss = '/fw/LOCALS/blogSite/tmpl_bsea/ADMIN/CKEdtiorContent.css ';
};
/**
 * Adding styles
 */
...
CKEDITOR.scriptLoader.load( '/fw/LOCALS/blogSite/tmpl_bseaAdmin/CKEditor/CKeditorRecord.js' );
/*var head = CKEDITOR.instances.metas.document.getHead();
var myscript = CKEDITOR.document.createElement( 'script', {
    attributes : {
        type : 'text/javascript',
        'data-cke-saved-src' : '/fw/LOCALS/blogSite/tmpl_bseaAdmin/CKEditor/CKeditorRecord.js'
    }
});
